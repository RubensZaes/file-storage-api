package com.rubenszaes.filestorageapi;
...
public class FileStorageController {
    ...
    public FileStorageController(FileStorageProperties fileStorageProperties) {
        this.fileStorgeLocation = Paths.get(fileStorageProperties.getUploadDir())
                                    .toAbsolutePath()
                                    .normalize();
    }
    ...
    public ResponseEntity<String> uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        try {
            Path targetLocation = fileStorgeLocation.resolve(fileName);
    ...
    public ResponseEntity<List<String>> listFiles() throws IOException {
        List<String> fileNames = Files.list(fileStorgeLocation)
